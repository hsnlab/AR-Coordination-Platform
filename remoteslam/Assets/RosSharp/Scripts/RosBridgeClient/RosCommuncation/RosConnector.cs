...
namespace RosSharp.RosBridgeClient
{
    public class RosConnector : MonoBehaviour
    {
        ...
        public static string RosBridgeServerUrl = "ws://192.168.0.183:9090";
        public string PonyRosServerUrl = "ws://192.168.0.1:9090";

        public bool SlamServer = true;
        ...
        private void ConnectAndWait()
        {
            ...
            {
                RosSocket = ConnectToRos(Protocol, PonyRosServerUrl, OnConnected, OnClosed);
                if (!isConnected.WaitOne(Timeout * 1000))
                    Debug.LogWarning("Failed to connect to PonyRosBridge at: " + PonyRosServerUrl);
            }
        }
